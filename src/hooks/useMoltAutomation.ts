...
export const useMoltAutomation = () => {
  ...
  useEffect(() => {
    ...
    const handleVelocityAlert = (e: Event) => {
      ...
      logSecurityEvent(`AUTONOMOUS_DEFENSE: Sub-human velocity (${velocity}ms) detected.`, 'HIGH');
      attemptAutonomousImprovement('Velocity anomaly detected. Hardening interaction thresholds.');
    };
