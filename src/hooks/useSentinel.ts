...
export const useSentinel = () => {
  ...
  const validateInput = useCallback((input: string): boolean => {
    ...
    const maliciousPatterns = [
      ...
      /\b(EventSource|FileReader|FileReaderSync|readAsDataURL|readAsText|readAsArrayBuffer)\b/i // Server-Sent Events streaming & asynchronous file/blob data reader exfiltration vector
    ];
