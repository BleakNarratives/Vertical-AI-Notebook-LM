...
export const PerspectiveWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    ...
    >
      ...
      {/* Enhanced Table Edge for seating perspective */}
      <div className="absolute -bottom-12 left-0 w-full h-12 bg-grey-dark/60 skew-x-[25deg] border-t border-grey-medium/30 pointer-events-none shadow-[0_-10px_30px_rgba(0,0,0,0.5)]" />
      {children}
    </div>
  );
};
