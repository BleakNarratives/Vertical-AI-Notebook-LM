...
export const FocusIndicator: React.FC<FocusIndicatorProps> = ({ color }) => {
  ...
  return (
    <div
      aria-hidden="true"
      className="absolute -inset-3 pointer-events-none opacity-0 group-focus-visible:opacity-100 group-hover:group-enabled:opacity-40 transition-all duration-300 scale-110 group-focus-visible:scale-105 group-hover:group-enabled:scale-105 z-50"
    >
      {/* Corner Brackets */}
