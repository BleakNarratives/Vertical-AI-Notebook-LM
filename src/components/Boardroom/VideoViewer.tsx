  ...
  return (
    <div className="absolute top-16 -right-12 flex flex-col items-center gap-2">
      ...
      <button
        ...
        className={`group/viewer group relative z-20 w-40 h-28 bg-grey-dark border border-grey-medium shadow-2xl transition-all hover:scale-105 focus-visible:scale-105 active:translate-y-1 focus-visible:ring-2 outline-none transform-gpu ${isActive ? 'focus-visible:ring-neon-amber' : 'focus-visible:ring-neon-red'}`}
      >
