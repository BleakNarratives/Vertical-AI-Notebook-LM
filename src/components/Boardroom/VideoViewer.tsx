  ...
  return (
    <div className="absolute top-16 -right-12 flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group relative z-20 w-40 h-28 bg-grey-dark border border-grey-medium shadow-2xl transition-all hover:scale-105 focus-visible:scale-105 active:translate-y-1 focus:outline-none transform-gpu"
      >
        ...
        <div className={`absolute -top-2 -left-2 w-2 h-2 border-t-2 border-l-2 opacity-0 group-focus-visible:opacity-100 transition-opacity pointer-events-none ${isActive ? 'border-neon-amber/50' : 'border-neon-red/50'}`} />
        <div className={`absolute -top-2 -right-2 w-2 h-2 border-t-2 border-r-2 opacity-0 group-focus-visible:opacity-100 transition-opacity pointer-events-none ${isActive ? 'border-neon-amber/50' : 'border-neon-red/50'}`} />
        <div className={`absolute -bottom-2 -left-2 w-2 h-2 border-b-2 border-l-2 opacity-0 group-focus-visible:opacity-100 transition-opacity pointer-events-none ${isActive ? 'border-neon-amber/50' : 'border-neon-red/50'}`} />
        <div className={`absolute -bottom-2 -right-2 w-2 h-2 border-b-2 border-r-2 opacity-0 group-focus-visible:opacity-100 transition-opacity pointer-events-none ${isActive ? 'border-neon-amber/50' : 'border-neon-red/50'}`} />
      </button>
    </div>
  );
};
