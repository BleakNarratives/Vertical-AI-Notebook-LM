  ...
  return (
    <div className="absolute top-16 -right-12 flex flex-col items-center gap-2">
      ...
      >
        ...
        <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-mono text-neon-amber opacity-0 group-hover/monitor:opacity-100 group-focus-visible/monitor:opacity-100 transition-opacity uppercase whitespace-nowrap">
          Monitor
        </span>
