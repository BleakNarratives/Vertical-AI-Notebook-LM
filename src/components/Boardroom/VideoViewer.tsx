  ...
  return (
    <div className="absolute top-16 -right-12 flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group relative z-20 w-40 h-28 bg-grey-dark border border-grey-medium shadow-2xl transition-all active:translate-y-1 focus:outline-none transform-gpu"
      >
