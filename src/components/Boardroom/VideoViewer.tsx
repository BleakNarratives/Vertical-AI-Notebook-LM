...
export const VideoViewer: React.FC = () => {
  return (
    ...
    >
      ...
      <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-[8px] font-mono text-grey-medium opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity uppercase whitespace-nowrap">
        Monitor
      </span>
    </button>
  );
