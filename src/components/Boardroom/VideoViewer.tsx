...
export const VideoViewer: React.FC = () => {
  return (
    <button
      ...
      className="group absolute top-16 -right-12 z-20 w-40 h-28 bg-grey-dark border border-grey-medium shadow-2xl transition-all hover:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-neon-red outline-none rotate-2"
    >
