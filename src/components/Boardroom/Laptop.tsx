  ...
  return (
    <div data-sentinel="laptop-terminal" className="flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group/laptop relative w-48 h-32 transition-all hover:scale-105 focus-visible:scale-105 active:translate-y-1 focus:outline-none transform-gpu"
      >
        {/* Laptop Screen (Open) */}
        ...
        <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-xs font-mono text-neon-red opacity-0 group-hover/laptop:opacity-100 group-focus-visible/laptop:opacity-100 whitespace-nowrap transition-opacity uppercase tracking-tighter">
