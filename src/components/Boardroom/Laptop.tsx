  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group relative w-48 h-32 transition-all hover:scale-105 focus-visible:scale-105 active:scale-95 active:translate-y-1 focus:outline-none transform-gpu"
      >
        {/* Laptop Screen (Open) */}
