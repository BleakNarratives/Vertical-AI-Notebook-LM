  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      >
        ...
        {/* Mug Body */}
        <div className={`absolute inset-0 bg-grey-dark border-x border-b border-grey-medium rounded-b-sm transition-all duration-500 ${isActive ? 'shadow-[0_0_15px_rgba(255,191,0,0.3)] border-neon-amber' : 'shadow-none'}`}>
           <div className={`absolute top-0 left-0 w-full h-2 bg-obsidian border-b transition-colors duration-500 ${isActive ? 'border-neon-amber' : 'border-grey-medium'}`} />
        </div>
