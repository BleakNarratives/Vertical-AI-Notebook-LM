  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group relative w-16 h-12 transition-all active:translate-y-1 focus:outline-none transform-gpu"
      >
        ...
        <span className="absolute -top-8 left-1/2 -translate-x-1/2 text-[10px] font-mono text-neon-amber opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 whitespace-nowrap transition-opacity">
          SAVE / LOAD / SETTINGS
        </span>
      </button>
    </div>
