...
const Paper: React.FC<PaperProps> = ({ label, title, rotation = '0deg', translateY = '0px', isActive, onClick }) => {
  return (
    ...
    >
      ...
      <span className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs font-mono text-neon-amber opacity-0 group-hover/paper:opacity-100 group-focus-visible/paper:opacity-100 transition-opacity uppercase whitespace-nowrap">
        {title}
      </span>
