...
const Paper: React.FC<PaperProps> = ({ label, title, rotation = '0deg', translateY = '0px', onClick }) => {
  return (
    <button
      ...
      className="group relative w-12 h-16 bg-white/5 border border-grey-medium transition-all hover:rotate-0 hover:translate-y-0 hover:scale-110 active:scale-105 active:translate-y-1 hover:bg-white/10 shadow-lg focus-visible:ring-2 focus-visible:ring-neon-amber outline-none overflow-hidden transform-gpu"
    >
