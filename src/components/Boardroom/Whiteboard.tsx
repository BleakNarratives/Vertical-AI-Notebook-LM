...
export const Whiteboard: React.FC = () => {
  return (
    <button
      ...
      className="absolute top-12 -left-12 w-32 h-48 bg-grey-dark border border-grey-medium shadow-2xl transition-all hover:scale-105 focus-visible:ring-2 focus-visible:ring-neon-amber outline-none -rotate-3"
    >
      ...
      <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[8px] font-mono text-grey-medium opacity-0 hover:opacity-100 transition-opacity uppercase">
        Whiteboard
      </span>
    </button>
  );
