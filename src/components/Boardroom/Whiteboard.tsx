  ...
  return (
    <div className="absolute top-12 -left-12 flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group/whiteboard group relative z-20 w-32 h-48 bg-grey-dark border border-grey-medium shadow-2xl transition-all hover:scale-105 focus-visible:scale-105 active:translate-y-1 focus-visible:ring-2 focus-visible:ring-neon-amber outline-none transform-gpu cursor-none"
      >
