  ...
  return (
    <div className="absolute top-12 -left-12 flex flex-col items-center gap-2">
      ...
      <button
        ...
        className="group relative z-20 w-32 h-48 bg-grey-dark border border-grey-medium shadow-2xl transition-all active:translate-y-1 focus:outline-none transform-gpu cursor-none"
      >
        ...
        <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-[10px] font-mono text-neon-amber opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity uppercase whitespace-nowrap">
          Whiteboard
        </span>
      </button>
    </div>
