    ...
    <div className="absolute top-12 -left-12 flex flex-col items-center gap-2">
      ...
      >
        ...
        <div className="absolute inset-2 bg-obsidian/50 border border-grey-dark p-2 overflow-hidden">
          ...
          <div className="w-full h-full border-l border-b border-neon-amber/20 flex flex-col gap-2 opacity-40 transition-opacity group-hover:opacity-80 group-focus-visible:opacity-80">
