  ...
  return (
    ...
    >
      ...
      <div className="text-center h-4 flex items-center justify-center">
        ...
        <p className="text-xs font-mono text-white/40 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 uppercase transition-opacity">{role}</p>
      </div>
