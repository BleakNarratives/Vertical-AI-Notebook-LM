  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="text-xs font-mono text-white/40 group-hover/persona:text-white/80 group-focus-visible/persona:text-white/80 uppercase transition-colors">{role}</p>
      </div>
